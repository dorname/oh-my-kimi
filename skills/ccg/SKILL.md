...
2. **Spawn parallel agents**: Launch 2-3 agents with the same prompt
   - `Agent(subagent_type="coder", description="Architect perspective review", prompt="You are the Architect reviewer. <question>")`
   - `Agent(subagent_type="coder", description="Critic perspective review", prompt="You are the Critic reviewer. <question>")`
   - `Agent(subagent_type="coder", description="Analyst perspective review", prompt="You are the Analyst agent. <question>")`
