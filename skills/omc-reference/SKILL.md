...
| `planner` | Task sequencing | Before multi-file implementations |
...
| `qa-tester` | Interactive validation | Manual testing |
| `git-master` | Git operations | Complex git maneuvers |
