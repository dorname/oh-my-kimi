...
- Use `Agent(subagent_type="coder", description="Deep causal analysis", ...)` for deep causal analysis
- Use `Agent(subagent_type="coder", description="Requirements analysis", ...)` for requirements analysis
